...
This means one can have an always-on abetd instance running, and another local abetd/abet-qt instance which connects to this node and receives blocks from it.
